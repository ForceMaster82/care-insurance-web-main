...
import SettlementsLogTransactionView from '../../views/settlements-log-transaction'
import {
  SearchCategory,
...
import useSettlementTransactionLog from '~hooks/api/settlement/use-settlement-transactoin-log'
...
const SettlementsInTransactionPage: NextPage = observer(() => {
  ...
  const {data: settlementListData} = useSettlementTransactionLog({
    pageNumber,
