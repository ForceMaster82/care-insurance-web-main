...
const CaregivingRoundsView = (props: IProps): ReactElement => {
  const {
    data,
    onClickListItem,
    onChangePageNumber,
      ...
      <Box gap="sm">
        <Box gap="xs">
          ...
          >
            ...
            <Button
              color="primary"
              disabled={!searchFilter.EXPECTED_CAREGIVING_START_DATE}
              onClick={onClickCsvDownload(
                searchFilter.EXPECTED_CAREGIVING_START_DATE,
              )}
              size="sm"
              variant="primary"
            >
...
export default CaregivingRoundsView
