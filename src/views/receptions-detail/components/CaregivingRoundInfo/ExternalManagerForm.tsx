...
const CaregivingRoundInfoExternalManagerForm = (
  props: IProps,
): ReactElement => {
  const {
    data,
  ...
  const setCaregiverOrganizationByCaregivingManagerOrganization =
    useCallback(() => {
      const caregiverOrganizationId =
        data.caregiverInfo?.caregiverOrganizationId
      const caregivingManagerOrganizationId =
        data.receptionInfo.caregivingManagerInfo?.organizationId

      if (!caregiverOrganizationId && caregivingManagerOrganizationId) {
        setValue(
          'caregiverInfo.caregiverOrganizationId',
          caregivingManagerOrganizationId,
        )
      }
    }, [
      data.caregiverInfo?.caregiverOrganizationId,
...
export default CaregivingRoundInfoExternalManagerForm
