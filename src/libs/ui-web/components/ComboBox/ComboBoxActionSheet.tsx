...
import {IComboBoxActionSheet} from './types'

export const ComboBoxActionSheet: FC<
  React.PropsWithChildren<IComboBoxActionSheet>
    ...
    >
      ...
      >
        <Box
          ...
          padding="sm"
        >
          <Typography textColor="n700" variant="subtitle1">
            {title}
          </Typography>
          <Box onClick={close}>
...
export default ComboBoxActionSheet
