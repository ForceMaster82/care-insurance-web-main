...
function SvgSearch(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg fill="none" height="1em" viewBox="0 0 64 64" width="1em" {...props}>
      ...
      />
      <path
        d="M37.333 40.267a2.933 2.933 0 012.934-2.934h4.918c.777 0 1.522.308 2.072.857l13.102 13.065a2.933 2.933 0 01-.016 4.17l-5.046 4.958a2.933 2.933 0 01-4.137-.026L38.184 47.29a2.933 2.933 0 01-.852-2.067v-4.956z"
        fill={props.fill}
      />
    </svg>
  )
